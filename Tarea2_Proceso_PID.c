...
#include <string.h> // Manejo de cadenas (strlen, strdup, memcpy)
...
char* read_maps_file(pid_t pid) {
    ...
    // Si el archivo estaba vacío o no se pudo leer
...
int main() {
    // Información del usuario que ejecuta el programa
    printf("Ejecutando como: %s (uid=%d)\n",
